...
var _whitespace = __webpack_require__(101);
...
var _enum = __webpack_require__(104);

var _enum2 = _interopRequireDefault(_enum);

var _pattern = __webpack_require__(105);
...
var asyncValidator = __webpack_require__(65);

console.log(asyncValidator);
var inputBuilding = dom.inputBuilding;
...
Page({
    ...
    submitHandle: function submitHandle() {
        ...
        var _data = this.data,
            logContent = _data.logContent,
            photoList = _data.photoList,
            isLoading = _data.isLoading;

        var userInfo = dataStore.get('userInfo');

        if (isLoading || !this.submitValidator(logContent)) return;

        wx.showLoading({ mask: true });

        this.uploadPhotoRequest(photoList).then(function (photoIds) {
            return _this.createBlogRequest({ logContent: logContent, photoIds: photoIds, userInfo: userInfo });
        }).then(function () {
            wx.hideLoading();
    ...
    uploadPhotoHandle: function uploadPhotoHandle() {
        var _this2 = this;

        var canUploadCount = this.data.photoListMax - this.data.photoList.length;
        ...
        wx.chooseImage({
            ...
            success: function success(res) {
                var photoList = _this2.data.photoList.concat(res.tempFilePaths);
                _this2.setData({ photoList: photoList });
            }
        });
    },

    submitValidator: function submitValidator(val) {
        if (!val) {
            var title = '请输入文本',
                icon = 'none';
            wx.showToast({ title: title, icon: icon });
    ...
    uploadPhotoRequest: function uploadPhotoRequest(tems) {
        if (!tems.length) {
            return Promise.resolve([]);
        }

        var PromiseAll = tems.map(function (tem) {
            return wx.cloud.uploadFile({
                cloudPath: pattern(new Date(), 'yyyy/MM/dd') + '/' + Math.random().toFixed(4),
                filePath: tem // 小程序临时文件路径
            });
        });
        return Promise.all(PromiseAll).then(function (res) {
    ...
    createBlogRequest: function createBlogRequest(data) {
...
__webpack_require__(7)(IteratorPrototype, __webpack_require__(11)('iterator'), function () {
  return this;
});
...
var _method = __webpack_require__(106);

var _method2 = _interopRequireDefault(_method);

var _number = __webpack_require__(107);
...
var _regexp = __webpack_require__(109);

var _regexp2 = _interopRequireDefault(_regexp);

var _integer = __webpack_require__(110);
...
var _array = __webpack_require__(112);
...
var _enum = __webpack_require__(114);

var _enum2 = _interopRequireDefault(_enum);

var _pattern = __webpack_require__(115);
